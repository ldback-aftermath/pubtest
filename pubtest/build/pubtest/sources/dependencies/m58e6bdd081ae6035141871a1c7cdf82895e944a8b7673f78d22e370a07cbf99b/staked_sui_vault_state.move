module 0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::staked_sui_vault_state {
	...
	struct StakedSuiVaultStateV1 has store, key {
		...
		validator_configs: sui::linked_table::LinkedTable<address, 0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::staked_sui_vault_state::ValidatorConfig>,
		...
		afsui_bin: sui::balance::Balance<0x5783fa2298e7301a1c7f99ce45d4a207478fbf3003eca9482ae823d6f6c7cd60::afsui::AFSUI>,
		pending_unstake_records: sui::table_vec::TableVec<0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::record::PendingUnstakeRecord>,
	...
	public(friend) fun borrow_pending_unstake_records(
		_arg0: &0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::staked_sui_vault_state::StakedSuiVaultStateV1
	): &sui::table_vec::TableVec<0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::record::PendingUnstakeRecord>
	{
		abort 0
	}
	...
	public(friend) fun borrow_pending_unstake_records_mut(
		_arg0: &mut 0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::staked_sui_vault_state::StakedSuiVaultStateV1
	): &mut sui::table_vec::TableVec<0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::record::PendingUnstakeRecord>
	{
		abort 0
	}
	...
	public(friend) fun take_validator_fee(
		_arg0: &mut sui::coin::Coin<0x5783fa2298e7301a1c7f99ce45d4a207478fbf3003eca9482ae823d6f6c7cd60::afsui::AFSUI>,
		_arg1: address,
		_arg2: u64,
		_arg3: &mut sui::tx_context::TxContext
	)
	...
	): sui::linked_table::LinkedTable<address, 0x58e6bdd081ae6035141871a1c7cdf82895e944a8b7673f78d22e370a07cbf99b::staked_sui_vault_state::ValidatorConfig>
	{
		abort 0
	}
